    ...
    <section>
      ...
      <div className='container'>
        <Box sx={{ margin: '30px 0px' }}>
          <CustomTitle text={`${params.category} collections`} fontWeight="bold" variant="h2" isCenter={true} />
                ...
                {collections.map((collection, index) => {
                  return <div className='col-md-4' key={index}>
                    <NftCards
                      ...
                      link={collection.reveal ? `/collections/gen/${collection._id.$oid}` : `/collections/${collection._id.$oid}`}
                    />
                  </div>
                })}
              </div>
