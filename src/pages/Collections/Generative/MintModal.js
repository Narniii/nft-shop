...
export default function MintModal({ open, onClose, collection, transactionHashes, count, loading, err }) {
    ...
    let items = [
        ...
        {
            name: "Price",
            value: `${collection.reveal[0].start_mint_price} Ⓝ`
        }
    ]
    ...
    return (
        ...
        >
            <Box sx={ModalStyle}>
                ...
                {loading ?
                    <Stack spacing={2} sx={{ alignItems: 'center', color: theme.pallete.lightBlue }}>
                        <CircularProgress />
                        <Typography>Loading...</Typography>
                        <Typography>This can take a while please Wait</Typography>
                    </Stack>
                    :
                    err ?
                        <Typography sx={{ color: 'red', fontSize: '16px', textAlign: 'center', fontWeight: "bold" }}>Error accured please try reloading the page.</Typography>
                        :
                        <>
                                ...
                                <Box sx={{ width: '100%' }}>
                                    <Box
                                        sx={{
                                            ...
                                            width: { xs: 250, md: 200 },
                                            backgroundImage: `url(${collection.reveal[0].reveal_link})`,
