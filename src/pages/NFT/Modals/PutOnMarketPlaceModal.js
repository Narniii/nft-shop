...
export default function PutOnMarketPlaceModal({ open, onClose, NFT, transactionHashes }) {
        ...
        >
            <Box sx={ModalStyle}>
                <Box sx={{ display: "flex", flexDirection: "row", justifyContent: "space-between", }}>
                    <Typography sx={{ margin: "10px 0px" }} id="modal-modal-title" variant="h6" component="h2">Listing Done</Typography>
                    <CloseIcon
